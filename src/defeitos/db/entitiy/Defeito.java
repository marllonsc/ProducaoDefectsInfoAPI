...
public class Defeito implements Serializable{
	...
	public Defeito(String id, String equipe, String userName, String priorizacao, String codigo, String sLA,
			String observacao, DataFormatada dataDaData, DataFormatada dataEntrega, String statusDesc, String sumario) {
		super();
		this.id = id;
		this.equipe = equipe;
	...
	public DataFormatada getDataDaData() {
		return dataDaData;
	}
	
	@XmlElement 
	public void setDataDaData(DataFormatada dataDaData) {
		this.dataDaData = dataDaData;
	}
	
	public DataFormatada getDataEntrega() {
		return dataEntrega;
	}
	
	@XmlElement 
	public void setDataEntrega(DataFormatada dataEntrega) {
		this.dataEntrega = dataEntrega;
	}
